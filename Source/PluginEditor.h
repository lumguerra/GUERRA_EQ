...
struct PathProducer
{
    PathProducer(SingleChannelSampleFifo<GUERRA_EQAudioProcessor::BlockType>& scsf) :
...
private:
    SingleChannelSampleFifo<GUERRA_EQAudioProcessor::BlockType>* leftChannelFifo;
...
struct ResponseCurveComponent : juce::Component,
    ...
    juce::Timer
{
    ResponseCurveComponent(GUERRA_EQAudioProcessor&);
