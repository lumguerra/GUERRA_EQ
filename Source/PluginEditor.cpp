...
//==============================================================================
ResponseCurveComponent::ResponseCurveComponent(GUERRA_EQAudioProcessor& p) :
    audioProcessor(p),
...
//==============================================================================
GUERRA_EQAudioProcessorEditor::GUERRA_EQAudioProcessorEditor(GUERRA_EQAudioProcessor& p)
    ...
    analyzerEnabledButtonAttachment(audioProcessor.apvts, "Analyzer Enabled", analyzerEnabledButton)
{
    ...
    auto safePtr = juce::Component::SafePointer<GUERRA_EQAudioProcessorEditor>(this);
...
GUERRA_EQAudioProcessorEditor::~GUERRA_EQAudioProcessorEditor()
{
...
//==============================================================================
void GUERRA_EQAudioProcessorEditor::paint(juce::Graphics& g)
{
    using namespace juce;
...
void GUERRA_EQAudioProcessorEditor::resized()
{
    auto bounds = getLocalBounds();
    bounds.removeFromTop(4);
...
std::vector<juce::Component*> GUERRA_EQAudioProcessorEditor::getComps()
{
    return
    {
        &peakFreqSlider,
